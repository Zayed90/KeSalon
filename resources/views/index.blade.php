  ...
  <div class="container">
    <div class="header_box">
      ...
      <div class="navbar-header">
        ...
        <li><a href="/admin" class="scroll-link">Login</a></li>
			</ul>
      </div>
	 </nav>
    </div>
        ...
        <div class="row">
          <div class="col-lg-5 col-sm-7">
            <div class="top_left_cont zoomIn wow animated"> 
              <h2>Tubes <strong>EAI</strong> Ke Salon</h2>
  ...
  <div class="container">
    ...
    <div class="team_section clearfix">
      <div class="team_area">
        ...
        <h3 class="wow fadeInDown delay-03s">Zayed</h3>
      ...
      <div class="team_area">
        ...
        <h3 class="wow fadeInDown delay-06s">Anggun</h3>
      ...
      <div class="team_area">
        ...
        <h3 class="wow fadeInDown delay-09s">Trisna</h3>
...
<footer class="footer_wrapper" id="contact">
      ...
      <div class="row">
        <div class="col-lg-4 wow fadeInLeft">	
		 <div class="contact_info">
                            <div class="detail">
                                <h4>Kesalon Infoway</h4>
                                <p>Sukapura dayeuhkolot, bandung</p>
                            </div>
                            <div class="detail">
                                <h4>call us</h4>
                                <p>+000009999988888</p>
  ...
  <div class="container">
    <div class="footer_bottom"><span>Copyright © 2014,    By me <a href="http://webthemez.com">Enterprise architecture integration</a>. </span> </div>
  </div>
</footer>
